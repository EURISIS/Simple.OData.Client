...
namespace Simple.OData.Client
{
    public static class ODataNameMatchResolver
    {
        ...
        public static INameMatchResolver AlpahumericCaseInsensitive = new ExactMatchResolver(true, StringComparison.Ordinal);
    ...
    public class ExactMatchResolver : INameMatchResolver
    {
        ...
        public ExactMatchResolver(bool alphanumComparison = false, StringComparison stringComparison = StringComparison.Ordinal)
        {
